...
@section('styles')
<style>
    /* Uses global tokens from layouts.frontend; local tweaks only */
    ...
    .stat-block { text-align: center; padding: 20px 0; }
    .stat-block .num {
        display: block;
        font-size: 3.5rem;
        font-weight: 800;
    ...
    @media (max-width: 768px) {
        ...
        .about-feature .feature-img { aspect-ratio: 4/3; margin-bottom: 40px; }
