@php
    ...
    $contactPage = $contactPage ?? \App\Models\ContactPageContent::viewDataWithDefaults();
    $contactHeroUrl = $contactHeroUrl ?? \App\Models\ContactPageContent::resolveHeroBackgroundUrl($contactPage['hero_bg_image'] ?? null);
@endphp
