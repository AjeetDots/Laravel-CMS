    ...
    <div class="row g-0 align-items-stretch">
        <div class="col-lg-6">
            <div class="testimonial-left">
                <img src="{{ $featuredPhoto ?: 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7' }}"
                     alt="{{ $featured->client_name }}"
                     class="testimonial-left__img"
                ...
                <div class="left-content">
                    <h2 id="testimonialLeftQuote">&ldquo;{{ $leftHeadline0 }}&rdquo;</h2>
