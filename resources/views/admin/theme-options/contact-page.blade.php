        ...
        <div class="card-header pb-0">
            <ul class="nav nav-tabs card-header-tabs theme-section-tabs" id="contactPageSectionTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="contact-hero-tab" data-bs-toggle="tab" data-bs-target="#contact-hero-pane" type="button" role="tab" aria-controls="contact-hero-pane" aria-selected="true">Hero</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-info-tab" data-bs-toggle="tab" data-bs-target="#contact-info-pane" type="button" role="tab" aria-controls="contact-info-pane" aria-selected="false">Info column</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-form-tab" data-bs-toggle="tab" data-bs-target="#contact-form-pane" type="button" role="tab" aria-controls="contact-form-pane" aria-selected="false">Form</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-map-tab" data-bs-toggle="tab" data-bs-target="#contact-map-pane" type="button" role="tab" aria-controls="contact-map-pane" aria-selected="false">Map</button>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content theme-section-tabs__panels" id="contactPageTabsContent">
                <div class="tab-pane fade show active" id="contact-hero-pane" role="tabpanel" aria-labelledby="contact-hero-tab" tabindex="0">
                    <div class="mb-3">
                        <label class="form-label" for="page_title">Browser tab title</label>
                        <input type="text" name="page_title" id="page_title" class="form-control" value="{{ old('page_title', $data['page_title'] ?? '') }}" maxlength="120">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="hero_line_1">Hero heading line 1</label>
                        <input type="text" name="hero_line_1" id="hero_line_1" class="form-control" value="{{ old('hero_line_1', $data['hero_line_1'] ?? '') }}" maxlength="255">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="hero_line_2">Hero heading line 2</label>
                        <input type="text" name="hero_line_2" id="hero_line_2" class="form-control" value="{{ old('hero_line_2', $data['hero_line_2'] ?? '') }}" maxlength="255">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="hero_cta">Hero button label</label>
                        <input type="text" name="hero_cta" id="hero_cta" class="form-control" value="{{ old('hero_cta', $data['hero_cta'] ?? '') }}" maxlength="120">
                    </div>
                    <div class="mb-0">
                ...
                <div class="tab-pane fade" id="contact-info-pane" role="tabpanel" aria-labelledby="contact-info-tab" tabindex="0">
                    <div class="mb-3">
                ...
                <div class="tab-pane fade" id="contact-form-pane" role="tabpanel" aria-labelledby="contact-form-tab" tabindex="0">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="subject_default">Default enquiry subject (hidden field)</label>
                        <input type="text" name="subject_default" id="subject_default" class="form-control" value="{{ old('subject_default', $data['subject_default'] ?? '') }}" maxlength="255">
                    </div>
                    <div class="row">
                ...
                <div class="tab-pane fade" id="contact-map-pane" role="tabpanel" aria-labelledby="contact-map-tab" tabindex="0">
                    <div class="form-check mb-3">
                        <input type="hidden" name="show_map" value="0">
                        <input class="form-check-input" type="checkbox" name="show_map" id="show_map" value="1" {{ (string) old('show_map', ($data['show_map'] ?? true) ? '1' : '0') === '1' ? 'checked' : '' }}>
                        <label class="form-check-label" for="show_map">Show map section</label>
                    </div>
                    <div class="mb-0">
                        <label class="form-label" for="map_embed_url">Google Maps embed URL</label>
                        <textarea name="map_embed_url" id="map_embed_url" class="form-control font-monospace small" rows="4" maxlength="5000" placeholder="https://www.google.com/maps/embed?...">{{ old('map_embed_url', $data['map_embed_url'] ?? '') }}</textarea>
