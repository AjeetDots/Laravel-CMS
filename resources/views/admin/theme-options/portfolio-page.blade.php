...
<div class="page-header-bar">
    <div>
        ...
        <p class="text-muted mb-0 small">Public listing at <code>/portfolio</code>. Section tabs organize the form; a single save updates every section. Projects are managed under <a href="{{ route('admin.portfolio.index') }}">Portfolio</a> in Content.</p>
    </div>
</div>
    ...
    <div class="card mb-4">
        <div class="card-header pb-0">
            <ul class="nav nav-tabs card-header-tabs theme-section-tabs" id="portfolioPageSectionTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="portfolio-intro-tab" data-bs-toggle="tab" data-bs-target="#portfolio-intro-pane" type="button" role="tab" aria-controls="portfolio-intro-pane" aria-selected="true">
                        Intro
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="portfolio-grid-tab" data-bs-toggle="tab" data-bs-target="#portfolio-grid-pane" type="button" role="tab" aria-controls="portfolio-grid-pane" aria-selected="false">
                        Grid
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="portfolio-bottom-tab" data-bs-toggle="tab" data-bs-target="#portfolio-bottom-pane" type="button" role="tab" aria-controls="portfolio-bottom-pane" aria-selected="false">
                        Bottom CTA
                    </button>
                </li>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content theme-section-tabs__panels" id="portfolioPageTabsContent">
                <div class="tab-pane fade show active" id="portfolio-intro-pane" role="tabpanel" aria-labelledby="portfolio-intro-tab" tabindex="0">
                    <div class="mb-3">
                ...
                <div class="tab-pane fade" id="portfolio-grid-pane" role="tabpanel" aria-labelledby="portfolio-grid-tab" tabindex="0">
                    <div class="mb-3">
                ...
                <div class="tab-pane fade" id="portfolio-bottom-pane" role="tabpanel" aria-labelledby="portfolio-bottom-tab" tabindex="0">
                    <div class="mb-3">
