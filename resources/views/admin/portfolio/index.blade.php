...
<div class="page-header-bar">
    <h1><i class="fas fa-briefcase me-2 text-primary"></i>Portfolio</h1>
...
<div class="card">
    <div class="card-header">All Projects ({{ $portfolios->count() }})</div>
    <div class="card-body p-0">
        @if($portfolios->isEmpty())
            <div class="text-center py-5 text-muted">
                <i class="fas fa-briefcase fa-3x mb-3 d-block opacity-25"></i>
                No projects yet. <a href="{{ route('admin.portfolio.create') }}">Add your first project</a>.
            </div>
        @else
