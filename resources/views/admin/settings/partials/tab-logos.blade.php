<div class="mb-0">
    ...
    <div class="mb-4">
        <label class="form-label fw-semibold" for="site_logo">Header logo <span class="text-danger">*</span> <small class="text-muted fw-normal">(light background)</small></label>
        ...
        <input type="file" name="site_logo" id="site_logo" class="form-control @error('site_logo') is-invalid @enderror"
               ...
               @if(!$settings->get('site_logo')) required @endif>
    ...
    <div class="mb-4">
        <label class="form-label fw-semibold" for="backend_logo">Backend logo <span class="text-danger">*</span> <small class="text-muted fw-normal">(admin sidebar)</small></label>
        ...
        <input type="file" name="backend_logo" id="backend_logo" class="form-control @error('backend_logo') is-invalid @enderror"
               accept=".jpg,.jpeg,.png,.gif,.webp,.svg,image/jpeg,image/png,image/gif,image/webp,image/svg+xml"
               @if(!$settings->get('backend_logo')) required @endif>
    ...
    <div class="mb-4">
        <label class="form-label fw-semibold" for="site_logo_footer">Footer logo <span class="text-danger">*</span> <small class="text-muted fw-normal">(dark background)</small></label>
        ...
        <input type="file" name="site_logo_footer" id="site_logo_footer" class="form-control @error('site_logo_footer') is-invalid @enderror"
               accept=".jpg,.jpeg,.png,.gif,.webp,.svg,image/jpeg,image/png,image/gif,image/webp,image/svg+xml"
               @if(!$settings->get('site_logo_footer')) required @endif>
    ...
    <div class="mb-0">
        <label class="form-label fw-semibold" for="site_favicon">Favicon <span class="text-danger">*</span></label>
        ...
        <input type="file" name="site_favicon" id="site_favicon" class="form-control @error('site_favicon') is-invalid @enderror"
               ...
               @if(!$settings->get('site_favicon')) required @endif>
