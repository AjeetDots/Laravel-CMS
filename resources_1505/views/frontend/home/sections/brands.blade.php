    ...
    <div class="container">
        <header class="brands-strip__head">
            ...
            <div class="brands-strip__title-block">
                <span class="finishes-intro__eyebrow">{{ $brandsStripKicker }}</span>
                <h2 class="home-atelier-headline" id="brands-strip-title">{{ $brandsStripTitleLine1 }} <br />{{ $brandsStripTitleLine2 }}</h2>
            </div>
            <span class="brands-strip__rule" aria-hidden="true"></span>
        </header>
