...
<div class="footer-newsletter" id="footer-newsletter">
    ...
    <form action="{{ route('newsletter.subscribe') }}" method="POST" class="footer-newsletter-form" aria-labelledby="footer-newsletter-heading" data-newsletter-ajax="1">
        @csrf
    ...
    form.addEventListener('submit', function (e) {
        ...
        fetch(form.action, {
            ...
            return res.json().then(function (data) {
                ...
                return { ok: false, status: res.status, data: { message: 'Something went wrong. Please try again.' } };
            });
        }).then(function (r) {
            if (submitBtn) {
            ...
            if (r.ok) {
                setStatus('success', (r.data && r.data.message) ? r.data.message : 'Thank you for subscribing!');
                form.reset();
                return;
            }
            var msg = (r.data && r.data.message) ? r.data.message : 'Please check your email and try again.';
