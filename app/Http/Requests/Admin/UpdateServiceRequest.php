...
class UpdateServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return array_merge([
            ...
            'image'             => ImageUploadRules::requiredUnlessModelColumn(2048, $this->route('service'), 'image'),
            'hover_image'       => ImageUploadRules::requiredUnlessModelColumn(2048, $this->route('service'), 'hover_image', 'remove_hover_image'),
