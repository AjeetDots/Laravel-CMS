...
class StoreBlogRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return array_merge($this->sortOrderValidationMessages(), [
            'slug.unique' => 'A post with this URL slug already exists. Use a different title, set a custom slug, or edit the existing post.',
        ]);
    }
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            'slug'         => ['nullable', 'string', 'max:255', Rule::unique('blog_posts', 'slug')->whereNull('deleted_at')],
