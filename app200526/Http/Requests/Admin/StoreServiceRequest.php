...
class StoreServiceRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return array_merge($this->sortOrderValidationMessages(), [
            'slug.unique' => 'A service with this URL slug already exists. Use a different title, set a custom slug, or edit the existing service.',
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            'slug'              => ['nullable', 'string', 'max:'.ServiceFormLimits::SLUG_MAX, Rule::unique('services', 'slug')->whereNull('deleted_at')],
            ...
            'hover_image'       => ImageUploadRules::required(2048),
            ...
            'sort_order'        => ['integer', 'min:1', SortOrderRules::uniqueAmong('services', [])],
            'is_active'         => 'boolean',
