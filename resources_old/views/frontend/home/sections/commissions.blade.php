    ...
    <div class="container">
        ...
        <div class="d-flex align-items-end justify-content-between mb-4 flex-wrap gap-3">
            ...
            <div class="reveal-right d-flex flex-wrap gap-2 justify-content-lg-end">
                ...
                <a href="{{ \App\Support\CmsOutboundHref::resolve(trim((string) $commissionsBtnUrl) !== '' ? $commissionsBtnUrl : null, 'contact') }}" class="btn-outline-site" style="font-size:.65rem;padding:10px 20px;">
