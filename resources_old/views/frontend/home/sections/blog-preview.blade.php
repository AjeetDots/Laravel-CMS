    ...
    <div class="container">
        <div class="row align-items-end mb-5">
            ...
            <div class="col-12 col-lg-3 offset-lg-2 text-lg-end mt-3 mt-lg-0 reveal-right">
                @if(trim((string) $blogPreviewButtonText) !== '')
                <a href="{{ \App\Support\CmsOutboundHref::resolve(trim((string) $blogPreviewButtonUrl) !== '' ? $blogPreviewButtonUrl : null, 'contact') }}" class="btn-outline-site">
            ...
            <div class="col-10 col-md-6 col-lg-4 flex-shrink-0 flex-lg-shrink-1 reveal delay-{{ $i + 1 }}">
                <a href="{{ route('blog.show', $post->slug) }}" class="blog-card d-block h-100">
                    ...
                    <div class="blog-card-body">
                        ...
                        @if(trim((string) $blogPreviewReadMoreText) !== '')
