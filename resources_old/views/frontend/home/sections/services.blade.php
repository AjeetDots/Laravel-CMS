    ...
    <div class="container">
        <div class="row align-items-end mb-5">
            ...
            <div class="col-lg-4 offset-lg-1 text-lg-end mt-3 mt-lg-0 reveal-right">
                @if(trim((string) $servicesBtnText) !== '')
                <a href="{{ \App\Support\CmsOutboundHref::resolve(trim((string) $servicesBtnUrl) !== '' ? $servicesBtnUrl : null, 'contact') }}" class="btn-outline-site">
            ...
            <div class="col-md-4 reveal delay-{{ $i + 1 }}">
                <a href="{{ route('services.show', $service->slug) }}" class="disc-card">
                    ...
                    <div class="disc-card-body">
                        ...
                        @endif
                        @if(trim((string) $servicesCardLinkText) !== '')
