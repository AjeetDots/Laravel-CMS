...
@section('title', trim((string) ($galleryPage['page_title'] ?? '')) !== '' ? $galleryPage['page_title'] : 'Gallery')
        ...
        <div class="gallery-showcase__grid" id="galleryGrid">
            ...
            <div class="gallery-showcase__empty text-center py-5">
                ...
                @if(!empty(trim($galleryPage['empty_btn_text'] ?? '')))
                    <a href="{{ \App\Support\CmsOutboundHref::resolve(!empty(trim($galleryPage['empty_btn_href'] ?? '')) ? $galleryPage['empty_btn_href'] : null, 'contact') }}" class="btn-outline-site">{{ $galleryPage['empty_btn_text'] }}</a>
                @endif
            </div>
            @endforelse
        </div>
...
<section class="gallery-bottom-cta">
    <div class="container text-center">
        ...
        @if(!empty(trim($galleryPage['bottom_btn_text'] ?? '')))
        <a href="{{ \App\Support\CmsOutboundHref::resolve(!empty(trim($galleryPage['bottom_btn_href'] ?? '')) ? $galleryPage['bottom_btn_href'] : null, 'contact') }}" class="gallery-bottom-cta__btn">{{ $galleryPage['bottom_btn_text'] }}</a>
        @endif
    </div>
</section>
