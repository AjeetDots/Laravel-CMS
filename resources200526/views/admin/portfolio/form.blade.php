                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="cover_image" class="form-control"
                               ...
                               @if(!isset($portfolio->id) || !$portfolio->cover_image) required @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="sort_order" class="form-control"
                               value="{{ old('sort_order', $portfolio->exists ? $portfolio->sort_order : ($defaultSortOrder ?? 1)) }}" min="1">
                        <div class="form-text">Each number may only appear once across all portfolio projects.</div>
                    </div>
